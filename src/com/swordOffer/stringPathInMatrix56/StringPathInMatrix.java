package com.swordOffer.stringPathInMatrix56;
...
public class StringPathInMatrix {
    public static void main(String[] args) {
        ...
        boolean result = hasPath(matrix, rows, cols, chars);
    ...
    public static boolean hasPath(char[] matrix, int rows, int cols, char[] str) {
        ...
        if (matrix == null || matrix.length == 0 || str == null
                || str.length == 0 || matrix.length != rows * cols || rows <= 0
                || cols <= 0 || rows * cols < str.length) {
            return false;
        }
    ...
    private static boolean hasPathCore(char[] matrix, int rows, int cols, char[] str, int row,
